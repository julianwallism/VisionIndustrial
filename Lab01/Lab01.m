...
F = eye(5); 
% Multiplicar una matriz por su inversa da como resultado la matriz identidad -> F = A*inv(A)
...
subplot(1,4,2)
imshow(negMoon)
title('Neg. Moon with nested loops')
...
subplot(1,4,3)
imshow(negMoon)
title('Neg. Moon with vectorized operations')
