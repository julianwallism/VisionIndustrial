...
% Load data
image_circuit = im2gray(imread('binarized_1.jpg'));
image_gantry = im2gray(imread('binarized_10.jpg'));
...
function subplot_to_delete = calculateHoughTransformation(image, fig_num)
    ...
    % Get detected lines
    lines = houghlines(bw_edge_image,theta,rho,peaks,'FillGap',5,'MinLength',500);
