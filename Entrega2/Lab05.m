...
% No observamos ninguna diferencia apreciable a simple vista, pero al hacer
% zoom podemos ver como el emborronamiento es menor en la imagen con el
% filtro ponderado frente a la imagen con el filtro de media
I = imread('letters.jpg');
I = im2gray(I);
I = im2double(I);
mask1 = [5/100 10/100 5/100; 10/100 40/100 10/100; 5/100 10/100 5/100];
mask2= [1/9 1/9 1/9; 1/9 1/9 1/9; 1/9 1/9 1/9];
cimage1 = correlation(I, mask1);
...
figure(5);
subplot(1,2,1), imshow(I), title('Sharpened');
subplot(1,2,2), imshow(cimage), title('Correlation');
...
% más nítida. Los bordes están más definidos y el color blanco resalta
% más.
I2 = imread('moon.bmp');
I2 = im2gray(I2);
I2 = im2double(I2);
